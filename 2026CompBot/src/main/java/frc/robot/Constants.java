...
public final class Constants {
  ...
  public static final double BAD_CURRENT_550 = 110.;  // Amps, stall current is 100
...
//Back Left
  ...
  public static class IntakeConstants {
    ...
    public static final double JointPositionConversionFactor = 110./41.857; //in -20, target in -20| out -58, target out 90
  ...
  public static class ClimberConstants {
    ...
    public static final double climbLevel1 = 230; //position for level1, Degrees
